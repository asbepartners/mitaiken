...
export function ExploreView({
  ...
  return (
    <div className="px-4 pb-4 pt-6">
      <header className="relative -mx-4 -mt-6 mb-5 h-56 overflow-hidden border-b border-green-100">
      ...
      {filtered.length > 0 && (
        <>
          <div className="mb-3 flex items-center justify-center px-1 text-sm font-medium text-ink-soft">
