  ...
  return (
    <div className="px-4 pb-4 pt-6">
      <header className="relative -mx-4 -mt-6 mb-4 h-36 overflow-hidden border-b border-green-100">
        ...
        <div className="absolute inset-x-0 top-0 flex items-start justify-between gap-4 px-5 py-2">
          ...
          <div className="min-w-0 text-right [text-shadow:0_1px_0_rgba(255,253,247,0.95)]">
            <div className="flex items-center justify-end gap-1.5">
              <h1 className="text-[1.7rem] font-bold leading-tight tracking-wide text-green-950">わたしのはじめて帖</h1>
              <span aria-hidden="true" className="-mt-4 text-sm text-[#d39a2c]">✦</span>
            </div>
            <p className="mt-0.5 text-sm font-medium text-green-950/80">まだ知らない「やってみたい」を見つけよう。</p>
          </div>
        </div>
      </header>
